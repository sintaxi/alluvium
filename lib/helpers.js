...
exports.normalize = function(analytics){
  ...
  encryptionTitleTable = {
    "connEn": "Encrypted",
    "connUn": "Unencrypted",
    "connR2En": "Forced HTTPS",
    "connR2Un": "Forced HTTP",
  }
  ...
  Object.keys(analytics.pFail).forEach(function(key){
    fail.push({ 
      path      : key,
      total     : analytics.pFail[key]["total"],
      breakdown : analytics.pFail[key]["breakdown"]
    })
  })
  ...
  return {
    ...
    general: {
      visits      : analytics.general.visits,
      connections : analytics.general.connAll,
