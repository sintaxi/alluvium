...
exports.createClient = function(cfg){
  ...
  return {
    ...
    write: function(data, callback){
      ...
      if (data.bwHead)
        transaction.zincrby([data.domain, date, "general"].join("::"), data.bwHead, "bwH")

      if (data.bwBody)
        transaction.zincrby([data.domain, date, "general"].join("::"), data.bwHead, "bwB")

      if (data.bwHead && data.bwBody)
        transaction.zincrby([data.domain, date, "general"].join("::"), data.bwHead + data.bwBody, "bwT")
